...
function renderNamespace(m: Manifest, now: number): string {
  ...
  return (
    ...
    `<div class="tablewrap" tabindex="0" role="region" aria-label="Secrets table for ${esc(m.namespace)}"><table><thead><tr><th scope="col">Key</th><th scope="col">Fingerprint</th><th scope="col">Targets</th></tr></thead>` +
