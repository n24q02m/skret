...
**Vulnerability:** Key-value secrets (e.g. `token=secret`) and static patterns (e.g. `sk-abc...`) embedded inside larger text like URL query strings or error messages completely bypassed the log redaction filter.
