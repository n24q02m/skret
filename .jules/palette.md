...
## 2026-08-21 - [Accessible Scrollable Regions]
...
**Action:** Always add `tabindex="0"`, `role="region"`, and an `aria-label` to containers with `overflow-x: auto` or similar scrollable styles.
