...
## 2026-06-21 - [Dynamic TUI Keybind Hints]
...
**Action:** When building interactive TUIs with toggleable states, always update contextual hints dynamically instead of using static placeholder text.
