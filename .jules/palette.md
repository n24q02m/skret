...
## 2026-09-05 - [Accessible Scrollable Regions]
...
**Action:** Always add `tabindex="0"`, `role="region"`, and `aria-label` attributes to scrollable container elements (e.g., `.tablewrap`) along with proper `:focus-visible` styling in the CSS.
