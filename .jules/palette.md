...
## 2026-08-22 - [Scrollable Region Accessibility]
...
**Action:** Always add `tabindex="0"`, `role="region"`, and a descriptive `aria-label` to scrollable containers like `.tablewrap`.
