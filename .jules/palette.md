...
## 2025-06-26 - [Dynamic TUI Keybind Descriptions]
...
**Action:** When displaying keybinds that toggle states, dynamically update the descriptive text in the view to match the resulting action of pressing the key in the current state.
