...
func (m Model) View() string {
	detail := ""
	// Baseline empty-state footer omits contextual navigation and reveal keybinds
	// to prevent user confusion when no items are selected (e.g. empty filter results).
