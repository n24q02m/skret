...
func TestResolvePath(t *testing.T) {
	cases := []struct {
		...
		{"bare relative path with colon but no slashes causing full traversal", "a:myapp", "a:myapp", true},
		{"path terminating without slash before valid segments", "a:b/c/d/e", "/c/d/e", true},
	}
	for _, c := range cases {
