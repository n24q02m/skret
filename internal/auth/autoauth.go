...
// Pre-lowercased substrings for O(1) strings.ToLower allocation in IsAuthError.
...
func IsAuthError(err error) bool {
	...
	// Hoist strings.ToLower outside the loop to avoid O(N) allocations per error check
