...
// sanitizeIDReplacer is hoisted to avoid redundant allocations on every sanitizeID call.
...
func sanitizeID(id string) string {
	// Fast path: skip replacement if none of the target characters exist.
