...
// sanitizeIDReplacer is hoisted to avoid per-call memory allocations and replacement table construction overhead.
...
func sanitizeID(id string) string {
	// OPTIMIZATION: Skip replacer entirely if no targeted special characters exist
